...
#     cwd '/tmp'
#     user 'root'
#     command 'curl -o /tmp/docker-ce-selinux-17.03.3.ce-1.el7.x86_64.rpm https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-selinux-17.03.3.ce-1.el7.x86_64.rpm'
# end
#
# execute 'get_containerd_package' do
#     cwd '/tmp'
#     user 'root'
#     command 'curl -o /tmp/containerd.io-1.2.13-3.2.el7.x86_64.rpm http://web.ermin/br2020-packages/containerd.io-1.2.13-3.2.el7.x86_64.rpm'
# end
#
# execute 'get_docker_package' do
#     cwd '/tmp'
#     user 'root'
#     command 'curl -o /tmp/docker-ce-19.03.10-3.el7.x86_64.rpm http://web.ermin/br2020-packages/docker-ce-19.03.10-3.el7.x86_64.rpm'
# end
#
# execute 'get_docker_cli_package' do
#     cwd '/tmp'
#     user 'root'
#     command 'curl -o /tmp/docker-ce-cli-19.03.10-3.el7.x86_64.rpm http://web.ermin/br2020-packages/docker-ce-cli-19.03.10-3.el7.x86_64.rpm'
# end
#
# rpm_package 'docker-ce-selinux' do
#     action :install
#     source '/tmp/docker-ce-selinux-17.03.3.ce-1.el7.x86_64.rpm'
# end
#
...
# Not reliable the version below so vendor it
