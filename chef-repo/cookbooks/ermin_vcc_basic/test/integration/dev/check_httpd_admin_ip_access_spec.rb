...
describe command('python /usr/local/bin/networks_regex_tool.py /etc/httpd/apache.conf "(\"\/Auth\/Admin\">\s+Require ip\s+)((\d+\.\d+\.\d+\.\d+(\/\d+)?\s)+)" 1') do
  ...
  its('stdout') { should eq '178.73.2.66 193.240.208.228 193.240.208.228 193.240.210.36 194.140.251.100 4.35.201.72/29 63.33.36.59 77.73.157.0/29 78.11.22.210 54.194.5.158 54.194.13.99 18.206.129.76 3.208.103.28 35.153.87.88 54.171.101.9 34.246.237.239 34.252.181.109 172.17.1.1 127.0.0.1 172.16.1.0/16 10.103.0.0/16 192.168.0.0/16' }
end
