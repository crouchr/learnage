  	...
  	<div class="container">
  		<div class="row">
  			<div class="col-md-6 col-md-offset-3">
  				...
  				<h3 class="page-header text-center"><i>Reve@l:Verify</i></h3>
				...
				<div class="intro_message">
					White-hats, grey-hats, black-hats, script kiddies and malware are constantly scanning the Internet looking for low-hanging fruit to exploit.
					Understand what the rest of the Internet <em>already</em> knows about your network by requesting a <span style="color:green">non-intrusive</span> Passive Vulnerability Report of your network.
					<br>
					<ul>
					<li>No IP traffic will be sent to your network;</li>
					<li>No vulnerability scans will be performed against your network;</li>
					<li>All information about your Network domain is derived from Open Source Intelligence (OSINT) databases;</li>
					<li>The Report takes between 5 and 10 minutes to be generated;</li>
					</ul>
					<h5>Please note that the Report is provided to you with no purchase necessary.</h5>
					<br>
				</div>	
				<form class="form-horizontal" role="form" method="post" action="index.php">
					...
					<div class="form-group">
						<label for="company" class="col-sm-3 control-label">Your Company</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" id="company" name="company" maxlength="40" pattern="^[\x00-\x7F]+$" data-toggle="tooltip" title="Enter the name of the company requesting the Report" placeholder="Company requesting the Report"  required>
						</div>
					</div>
					<div class="form-group">
					  <label for="country" class="col-sm-3 control-label">Country</label>
					  <div class="col-sm-4">
					    <select class="form-control" id="country" name="country" data-toggle="tooltip" title="This information is used to tailor the results of the Business Impact Chapter in the Report">
					  ...
					  <div class="col-sm-4">
					    <select class="form-control" id="industry" name="industry" data-toggle="tooltip" title="This information is used to tailor the results of the Business Impact Chapter in the Report">
					      <option>Unspecified</option>
					...
					<div class="form-group">
						<label for="name" class="col-sm-3 control-label">Network Domain</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" id="domain" name="domain" maxlength="40" data-toggle="tooltip" pattern="[A-Za-z0-9._%+-]+\.[a-z\s]{2,3}$" title="Enter the DNS domain of the network for which the assessment is required, e.g. acme.com" placeholder="Domain of IP network to assess" value="<?php echo htmlspecialchars($_POST['domain']);?>" required oninvalid="setCustomValidity('Please enter a valid domain name.')" oninput="setCustomValidity('')">
						</div>
					</div>
					<div class="form-group">
